        ...
        <div className="destination">
          ...
          <div className="content-container">
            ...
            <div className="destination-nav text-8">
              <a href="#moon" onClick={() => setIdx(0)} className={(idx === 0 ? 'active' : '')}>Moon</a>
              <a href="#mars" onClick={() => setIdx(1)} className={(idx === 1 ? 'active' : '')}>Mars</a>
              <a href="#europa" onClick={() => setIdx(2)} className={(idx === 2 ? 'active' : '')}>Europa</a>
              <a href="#titan" onClick={() => setIdx(3)} className={(idx === 3 ? 'active' : '')}>Titan</a>
            </div>
